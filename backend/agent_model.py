...
SYSTEM_PROMPT = (
    ...
    "than guessing which one they meant. If a tool reports that a schedule "
    "week is not prepared, say that clearly and direct the supervisor to "
    "prepare that week in the Schedule screen; never describe it as proof "
